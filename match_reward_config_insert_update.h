#ifndef __MATCH_REWARD_CONFIG_INSERT_UPDATE_H__
#define __MATCH_REWARD_CONFIG_INSERT_UPDATE_H__
class MatchRewardConfigInsertUpdateRequest
{
public:
	MatchRewardConfigInsertUpdateRequest(const string& json) {
...
class MatchRewardConfigInsertUpdateResponse
{
public:
	MatchRewardConfigInsertUpdateResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
